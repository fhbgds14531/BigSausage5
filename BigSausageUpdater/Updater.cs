...
namespace BigSausageUpdater {
    public class Updater {
        ...
        private static readonly string VERSION_URL = "https://s3.us-west-2.amazonaws.com/cdn.mizobogames.net/bigsausage/newVersion.txt";
        private static readonly string DOWNLOAD_URL = "https://s3.us-west-2.amazonaws.com/cdn.mizobogames.net/bigsausage/Versions/";
